...
- [Prod data seeding](prod-data-seeding.md) — prod rows only reach prod via Publish "overwrite data" (wholesale); agent can't write prod; seed attaches generic modules to WORKSHOP cohort only, env-specific ids.
